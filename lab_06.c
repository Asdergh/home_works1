...
//  в функцию передается два параметра строка для парсинга и ключь по которому проводиться парсинг в данном случае это символ типа char
// на выход функция ничгео не передает она типа void
// это было задание номер 1
